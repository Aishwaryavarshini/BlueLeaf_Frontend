  ...
  return (
    <div className="h-full flex flex-col relative animate-fade-in overflow-hidden bg-[#eff6ff]">
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-24 space-y-8 relative z-10">
        <div className="bg-[#f0f7ff] rounded-[2.5rem] p-10 border-2 border-[#2563eb]/10 shadow-2xl mt-4">
        ...
        {ALGEBRA_FORMULAS.map((formula) => (
          <div 
            key={formula.id}
            className="bg-[#f0f7ff] rounded-[2.5rem] border-2 border-[#2563eb]/10 shadow-lg p-8 space-y-6 active:scale-[0.99] active:border-[#2563eb] active:bg-blue-50 transition-all group"
          >
            ...
            <div className="bg-blue-50/50 rounded-3xl p-8 flex items-center justify-center border-2 border-[#2563eb]/5 group-active:bg-white transition-all shadow-inner">
        ...
        <div className="p-10 text-center bg-blue-100/20 backdrop-blur-md rounded-[3rem] border border-blue-200/30 mb-10">
